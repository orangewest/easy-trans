package io.github.orangewest.easytrans.demo.jpa.repository;

import io.github.orangewest.easytrans.demo.jpa.driver.TransDriver;
...
/**
 * 通用数据库翻译仓库：根据 {@link io.github.orangewest.easytrans.demo.jpa.annotation.DbTransRepo#entity()}
